...
function displaySingularRamen(ramenObj) {
  ...
  //create a ramen form
//Add e.prevent to stop form refreshing
// create an new ramen object
//target the ramen object using e.target method
//pass new ramen object as an argument
